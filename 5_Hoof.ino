...
static int Stride_Hoof(struct pt * pt) {
  static unsigned long PWM_High = HOOF_PWM_HIGH;
  static unsigned long Leg = HOOF;
  static unsigned long Wait = HOOF_WAIT;
  static unsigned long Duration = HOOF_DURATION;
  static unsigned long Ramp_Increment = HOOF_PWM_INCREMENT;
