...
static int Stride4(struct pt * pt) {
  static unsigned long PWM_High = LEG_4_PWM_HIGH;
  static unsigned long Leg = LEG_4;
  static unsigned long Wait = LEG_4_WAIT;
  static unsigned long Duration = LEG_4_DURATION;
